...
public class ServicosFedex {
	...
	public enum Servicos{
		...
		FEDEX_FREIGHT(10010, "FREIGHT", 10.00, 
		...
		FEDEX_ECONOMY(410045, "Economy", 5.00,
				Arrays.asList(Ceps.SP_CAPITAL, Ceps.SP_GRANDESP, Ceps.SP_LITORAL, Ceps.SP_INTERIOR, Ceps.RJ_CAPITAL,
						Ceps.RJ_GRANDERIO, Ceps.RJ_INTERIOR, Ceps.ES_CAPITAL, Ceps.ES_INTERIOR, Ceps.MG_CAPITAL, Ceps.MG_GRANDEBH,
						Ceps.MG_INTERIOR)), 

		FEDEX_EXPRESS(410126, "Express", 15.00,
				Arrays.asList(Ceps.SP_CAPITAL, Ceps.SP_GRANDESP, Ceps.SP_LITORAL, Ceps.SP_INTERIOR, Ceps.RJ_CAPITAL,
						Ceps.RJ_GRANDERIO, Ceps.RJ_INTERIOR, Ceps.ES_CAPITAL, Ceps.ES_INTERIOR, Ceps.MG_CAPITAL, Ceps.MG_GRANDEBH,
						Ceps.MG_INTERIOR)), 

		FEDEX_TOTAL(10215, "TOTAL", 12.00,
				Arrays.asList(Ceps.SP_CAPITAL, Ceps.SP_GRANDESP, Ceps.SP_LITORAL, Ceps.SP_INTERIOR, Ceps.RJ_CAPITAL,
						Ceps.RJ_GRANDERIO, Ceps.RJ_INTERIOR, Ceps.ES_CAPITAL, Ceps.ES_INTERIOR, Ceps.MG_CAPITAL, Ceps.MG_GRANDEBH,
						Ceps.MG_INTERIOR));
