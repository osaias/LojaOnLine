...
public class ServicosTotalExpress {
	...
	public enum Servicos{
		...
		TOTAL_INTERNATIONAL(10010, "International", 25.00,
		...
		TOTAL__ECONOMY(410045, "Economy", 2.00,
				Arrays.asList(Ceps.SP_CAPITAL, Ceps.SP_GRANDESP, Ceps.SP_LITORAL, Ceps.SP_INTERIOR, Ceps.RJ_CAPITAL, Ceps.RJ_GRANDERIO, 
						Ceps.RJ_INTERIOR, Ceps.ES_CAPITAL, Ceps.ES_INTERIOR, Ceps.MG_CAPITAL, Ceps.MG_GRANDEBH, Ceps.MG_INTERIOR, 
						Ceps.DF_CAPITAL, Ceps.DF_SATELITE, Ceps.GO_CAPITAL, Ceps.GO_GRANDEGOIANIA, Ceps.GO_INTERIOR, Ceps.PR_CAPITAL, 
						Ceps.PR_GRANDECURITIBA, Ceps.PR_INTERIOR, Ceps.SC_CAPITAL, Ceps.SC_GRANDEFLORIANOPOLIS, Ceps.SC_INTERIOR, 
						Ceps.RS_CAPITAL, Ceps.RS_GRANDEPORTOALEGRE, Ceps.RS_INTERIOR)), 

		TOTAL_EXPRESSO(410126, "Expresso", 12.00,
				Arrays.asList(Ceps.SP_CAPITAL, Ceps.SP_GRANDESP, Ceps.SP_LITORAL, Ceps.SP_INTERIOR, Ceps.RJ_CAPITAL, Ceps.RJ_GRANDERIO, 
						Ceps.RJ_INTERIOR, Ceps.ES_CAPITAL, Ceps.ES_INTERIOR, Ceps.MG_CAPITAL, Ceps.MG_GRANDEBH, Ceps.MG_INTERIOR, 
						Ceps.DF_CAPITAL, Ceps.DF_SATELITE, Ceps.GO_CAPITAL, Ceps.GO_GRANDEGOIANIA, Ceps.GO_INTERIOR, Ceps.PR_CAPITAL, 
						Ceps.PR_GRANDECURITIBA, Ceps.PR_INTERIOR, Ceps.SC_CAPITAL, Ceps.SC_GRANDEFLORIANOPOLIS, Ceps.SC_INTERIOR, 
